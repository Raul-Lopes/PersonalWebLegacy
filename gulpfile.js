...
gulp.task('copy', ['clean'], function(){ //copiar arquivos para pasta de destino 
    return gulp.src([
        'src/components/bootstrap/dist/**/*', 
        'src/components/bootstrap/fonts/**/*', 
        'src/components/bootstrap/js/**/*',         
        'src/components/popper.js/dist/**/*',        
        'src/components/jquery/dist/**/*', 
        'src/components/wowjs/dist/**/*',
        'src/components/wowjs/css/libs/**/*',
        'src/components/imagehover.css-master/css/**/*',
...
gulp.task('sass', function(){
    return gulp.src(['./src/sass/**/*.scss', './src/sass/**/*.sass']) //copila as duas extensoes 
        .pipe(sass())
        .pipe(autoprefixer())
        .pipe(cssnano())
